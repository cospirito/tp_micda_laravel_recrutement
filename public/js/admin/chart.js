$(function () {
  ...
  // debut costums lines 
  var datamonth = {
    labels: ["Janv-Mars", "Avril-Juin", "Juie-Sept", "Oct-Dev"],
    datasets: [{
      label: '# commandes',
      data: [10, 19, 3, 15],
      backgroundColor: [
  ...
  // debut costums lines : demande de devis
  var datadays_ddv = {
    labels: ["Lun", "Mar", "Mer", "Jeu", "Ven", "Sam", "Dim"],
    datasets: [{
      label: '# demandes devis',
      data: [10, 19, 3, 15, 6, 8, 9, 8],
      backgroundColor: [
        'rgba(255, 99, 132, 0.2)',
        'rgba(54, 162, 235, 0.2)',
        'rgba(255, 206, 86, 0.2)',
  ...
  //Chart pour les commandes clients
  if ($("#cmdChart").length) {
    var cmdChartCanvas = $("#cmdChart").get(0).getContext("2d");
    // This will get the first returned node in the jQuery collection.
    var barChart = new Chart(cmdChartCanvas, {
      type: 'bar',
      data: datamonth,
      options: options
    });
  ...
  //Chart pour les demandes devis utilisateurs
  if ($("#ddvChart").length) {
    var ddvChart = $("#ddvChart").get(0).getContext("2d");
    // This will get the first returned node in the jQuery collection.
    var barChart = new Chart(ddvChart, {
      type: 'bar',
      data: datadays_ddv,
      options: ddoptions,
    });
