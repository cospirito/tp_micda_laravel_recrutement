            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
              <div class="auth-form-transparent text-left p-3">
                <div class="brand-logo">
                  Recruzone App TPMICA BY Marc Guei
                </div>
                <h4> Connectez-vous ou Inscrivez-vous</h4>                
                <form class="pt-3">
                  <div class="form-group">
                    <label for="exampleInputEmail">Nom d'ultilisateur</label>
                  ...
                  <div class="my-3">
                    <a class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" href="../../index.html">LOGIN</a>
                  </div>
